...
from university import Course, Mentor, Teacher, Student, University, Person
...
# )
# some_person = Person ('Gala', 'Gorb', date(1976, 11, 8))
# print(some_person)
present_python = Course ("Python", date(2022, 7, 1), date(2022, 8, 15))
# print(present_python.is_active())
some_teacher = Teacher ('Gala', 'Gorb', date(1978, 12, 8), 100, 'Python')
# some_teacher.get_yearly_salary()
some_teacher.answer_question("python", 'gsgsg')
# print(present_python.__dict__)
# print(present_python.__dict__)
# print(some_teacher.__dict__)
# print(some_teacher)